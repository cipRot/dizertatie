angular.module('comparison_api').controller('DashboardController', function($rootScope, $scope, $location, $http) {
    ...
    $(function() {
		...
		$scope.compareLocal = function(){
			$http.post("http://localhost:3000/compareLocalFiles", $scope.obj).success(function(data){ 
		   		loadIframe("frame",data.URL) 
		   	})
		}
